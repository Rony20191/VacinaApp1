        ...
        <v-row dense justify="center" align="center" class="ma-4">
            <v-card width="600px">
                ...
                <v-card-actions class="justify-center">
                    <v-btn color="primary" @click="cadastrarPaciente">
                        Cadastrar
                    </v-btn>
    ...
    data() {
        return {
            ...
            nomeRules: [
                ...
                v =>
                    (v && v.length > 3) ||
                    "O nome tem que ser maior 3 caracteres"
            ],
            dataRules: [v => !!v || "Data de nascimento é obrigatório"],
            cpfRules: [
                cpf => {
                    let result = true;
                    let soma;
    ...
    methods: {
        async cadastrarPaciente() {
            ...
            try {
                ...
                this.$swal.fire('Paciente Cadastra com sucesso!!','<br/>','success').then(()=>{

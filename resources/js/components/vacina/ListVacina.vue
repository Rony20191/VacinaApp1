<template>
    <v-container fluid>
        <v-card>
            ...
            <v-card-text>
                <v-data-table :loading="table.loading" :items="table.items" :headers="table.headers" :search="table.search" >
        ...
        return {
            table: {
                ...
                headers: [
                    ...
                    {text:'Intervalo mínimo entre doses(Dias)',value:'intervalo_minimo'}
                ],
                items:[],
                search:''
            }
    ...
    methods: {
        async getVacinas(){
            try{
                ...
                this.table.items = []
                const {data} = await  axios.get('/vacinas');
